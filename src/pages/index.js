...
export default function Home() {
  return (
    <>
      <Head>
        <title>Dev-Erika | Inicio</title>
        <meta name="description" content="Generated by create next app" />
      </Head>
      <TransitionEffect />
      <main className="flex items-center w-full  bg-light dark:bg-black text-dark dark:text-light md:items-start">
        <section className="flex items-center my-10 bg-white dark:bg-black w-full lg:flex-col">
          ...
          <div className="w-1/2 rounded-lg bg-white dark:bg-black flex flex-col items-center self-center p-[20px] lg:w-full lg:text-center">
            <AnimatedText
            ...
            <div className="flex items-center gap-1 self-start mt-2 lg:self-center ">
              ...
              <Link
                href="/"
                target={"_black"}
                className="text-lg px-2 font-medium capitalize text-dark dark:text-light underline  md:text-sm"
              >
                Contacto
              </Link>
            </div>
