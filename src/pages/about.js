...
export default function about() {
  return (
    <>
      ...
      <TransitionEffect />
      <main className="w-full p-8 flex flex-col gap-7 bg-light dark:bg-dark items-center justify-center ">
        ...
        <section className="grid w-full grid-cols-8 gap-16 sm:gap-8">
          ...
          <div className="col-span-2 flex flex-col justify-between xl:col-span-8 xl:flex-row md:order-3">
            {historicalData.map((data) => (
              ...
              >
                <span className="inline-block text-7xl font-bold md:text-6xl sm:text-5xl xs:text-4xl text-dark/75 dark:text-light">
