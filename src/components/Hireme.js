...
const Hireme = () => {
  return (
    <div className="fixed left-4 bottom-4 flex justify-center items-center overflow-hidden md:right-3 md:left-auto md:top-0 md:bottom-auto md:absolute ">
